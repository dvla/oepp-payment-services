...
public class PaymentBrokerClientRetrievePaymentServerErrorsTest extends BasePaymentBrokerClientTest {
    ...
    public void shouldThrowUnexpectedResponseExceptionWhenErrorFromPaymentBroker() {
        ...
        mockServerErrorResponse(RETRIEVE_PAYMENT_PATH, errorCode);

        try {
            client.retrievePayment(createRetrievePaymentRequest());
