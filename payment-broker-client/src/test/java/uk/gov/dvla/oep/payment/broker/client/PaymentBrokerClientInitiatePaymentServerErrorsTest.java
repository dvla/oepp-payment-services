...
public class PaymentBrokerClientInitiatePaymentServerErrorsTest extends BasePaymentBrokerClientTest {
    ...
    public void shouldThrowUnexpectedResponseExceptionWhenErrorFromPaymentBroker() {
        ...
        mockServerErrorResponse(INITIATE_PAYMENT_PATH, errorCode);

        try {
            client.initiatePayment(createInitiatePaymentRequest());
